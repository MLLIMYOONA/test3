...
class NeuralPointProcess(TemporalPointProcess):
    ...
    def logprob(self, event_times, spatial_locations, input_mask, t0, t1):
        intensities, Lambda, _, final_state = self.integrate_lambda(event_times, spatial_locations, input_mask, t0, t1, self.solver)
        ...
        return final_state, Lambda, logprob
    ...
    def integrate_lambda(self, event_times, spatial_location, input_mask, t0, t1, method, nlinspace=1):
        ...
        if t1 is not None:
            ...
            state_traj = self.ode_solver.integrate(t0, t1, state, nlinspace=nlinspace, method=method)
        ...
        return intensities, Lambda, prejump_hidden_states, final_state
